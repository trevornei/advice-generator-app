...
export default function DiceCont() {
    return(
        <>
            <div className="flex items-center justify-center w-16 h-16 rounded-full bg-neonGreen hover:shadow-lg hover:shodow-neonGreen hover:ease-in-out hover:duration-300">
