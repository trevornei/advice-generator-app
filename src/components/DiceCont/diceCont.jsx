    ...
    return(
        <>
            <button type="button" onClick={getAdvice} >
                <div className="z-10 flex items-center justify-center w-16 h-16 transition-shadow duration-300 rounded-full bg-neonGreen hover:shadow-3xl hover:shadow-neonGreen">
